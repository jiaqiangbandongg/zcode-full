...
const enUS: Record<string, string> = {
  ...
  "settings.gitBackup.description": "Automatically back up your workspace .git repository to your own Alibaba Cloud OSS bucket. Keys are generated locally; your private key never leaves your device.",
  ...
  "settings.gitBackup.encryption.exportWarning": "The private key is the only way to restore backups. Keep it safe.",
  ...
  "gitBackup.welcome.description": "ZCode Full Edition can automatically back up your .git repository history to your own Alibaba Cloud OSS bucket. Backups are encrypted with AES-256-CTR + RSA-OAEP. Keys are generated on your device; your private key never leaves your machine.",
