...
const zhCN: Record<string, string> = {
  ...
  "settings.gitBackup.description": "将工作区 .git 仓库自动备份到你自己的阿里云 OSS 存储桶。密钥在本地生成，私钥从不离开你的设备。",
  ...
  "gitBackup.welcome.description": "ZCode 满血版支持将你的 .git 仓库历史自动备份到你自己的阿里云 OSS 存储桶。备份使用 AES-256-CTR + RSA-OAEP 加密，密钥在你的设备本地生成，私钥从不离开你的设备。",
